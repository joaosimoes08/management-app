...
const messages: Record<AppLocale, Record<string, string>> = {
  'pt-PT': {
    ...
    'nav.dashboard': 'Dashboard', 'nav.infrastructure': 'Infraestrutura', 'nav.portal': 'Portal interno', 'nav.ipam': 'IPAM', 'nav.discovery': 'Descoberta', 'nav.audit': 'Auditoria', 'nav.settings': 'Definições', 'nav.help': 'Ajuda e suporte',
  ...
  'en-US': {
    ...
    'nav.dashboard': 'Dashboard', 'nav.infrastructure': 'Infrastructure', 'nav.portal': 'Internal portal', 'nav.ipam': 'IPAM', 'nav.discovery': 'Discovery', 'nav.audit': 'Audit', 'nav.settings': 'Settings', 'nav.help': 'Help and support',
